    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            if (isset($_GET['post_id'])) {
                ...
                $view_query = "UPDATE posts SET view_count = view_count + 1 ";
                $view_query.= "WHERE id = $post_id";
                $send_viw_query = mysqli_query($connection, $view_query);
                
                handlingMySqlError($send_viw_query);
            ...
            ?>
                    ...
                    <p><span class="glyphicon glyphicon-time"></span><?php echo $post_date; // Posted on August 28, 2013 at 10:00 PM 
                                                                        ?></p>
                    <hr>
